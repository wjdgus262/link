		...
		<div class="qnawriter_wrap">
			<div class="qnawriter_title">
				...
				<select class="qnaselect">
					<optgroup label="취업">
						<option value="취업">서류전형</option>
						<option value="취업">면접전형</option>
						<option value="취업">집단토의</option>
					</optgroup>
					<optgroup label="직장생활">
						<option value="직장생활">기업별 장단점</option>
						<option value="직장생활">직무별 장단점</option>
						<option value="직장생활">능력개발</option>
					</optgroup>
